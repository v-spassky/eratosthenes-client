const chatPrompts = [
    ...
    "Истина прячется за пеленой слов, стоит лишь ее разгадать.",
    ...
    "Оставим свой след в истории, написав ее вместе.",
    ...
    "Истина может быть скрыта, но мы вместе ее обнаружим.",
    ...
    "Истина скрывается за ширмой слов, стоит лишь ее отодвинуть.",
